...
//    self.cellTopLabel.textAlignment = NSTextAlignmentCenter;
    self.cellTopLabel.font = [UIFont fontWithName:@"Poppins-Bold" size:12.0f];
    self.cellTopLabel.textColor = [UIColor lightGrayColor];

    self.messageBubbleTopLabel.font = [UIFont fontWithName:@"Poppins-Regular" size:12.0f];
   ...
   // self.messageBubbleImageView.contentMode = UIViewContentModeScaleAspectFit; // shweta bubbleimage
    ...
    self.cellBottomLabel.font = [UIFont fontWithName:@"Poppins-Regular" size:11.0f];
