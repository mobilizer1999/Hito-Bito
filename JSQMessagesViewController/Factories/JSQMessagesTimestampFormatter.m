...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _dateTextAttributes = @{ NSFontAttributeName : [UIFont fontWithName:@"Poppins-Bold" size:12.0f],
                                 NSForegroundColorAttributeName : [UIColor grayColor],
                                 NSParagraphStyleAttributeName : paragraphStyle };
        
        _timeTextAttributes = @{ NSFontAttributeName : [UIFont fontWithName:@"Poppins-Regular" size:12.0f],
                                 NSForegroundColorAttributeName : [UIColor grayColor],
                                 NSParagraphStyleAttributeName : paragraphStyle };
    }
    return self;
